...
#define UHF_CS GPIO(GPIO_PORTA, 2)
#define UHF_RST GPIO(GPIO_PORTA, 3)
#define UHF_MOSI GPIO(GPIO_PORTA, 4)
#define UHF_MISO GPIO(GPIO_PORTA, 6)
...
#define UHF_SCK GPIO(GPIO_PORTB, 25)
