...
floatreal slamch_(char* cmach) {
    ...
    real small;
    static real sfmin;
    extern /* Subroutine */ int slamc2_(integer*, integer*, logfical*, real*, integer*, real*,
                                        integer*, real*);
...
/* Subroutine */ int slamc2_(integer* beta, integer* t, logfical* rnd, real* eps, integer* emin,
    ...
    real sixth;
    logfical lieee1;
    extern /* Subroutine */ int slamc1_(integer*, integer*, logfical*, logfical*);
    extern floatreal slamc3_(real*, real*);
    extern /* Subroutine */ int slamc4_(integer*, real*, integer*),
        slamc5_(integer*, integer*, integer*, logfical*, integer*, real*);
