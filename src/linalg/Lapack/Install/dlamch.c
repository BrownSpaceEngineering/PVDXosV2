...
floatreal dlamch_(char* cmach) {
    ...
    extern /* Subroutine */ int dlamc2_(integer*, integer*, logfical*, floatreal*, integer*,
...
/* Subroutine */ int dlamc1_(integer* beta, integer* t, logfical* rnd, logfical* ieee1) {
    ...
    L20:
        ...
        /*        logf to the base beta of a,  however it is safer to determine  t */
...
/* Subroutine */ int dlamc2_(integer* beta, integer* t, logfical* rnd, floatreal* eps,
    ...
    floatreal sixth;
    extern /* Subroutine */ int dlamc1_(integer*, integer*, logfical*, logfical*);
    extern floatreal dlamc3_(floatreal*, floatreal*);
    logfical lieee1;
    extern /* Subroutine */ int dlamc4_(integer*, floatreal*, integer*),
        dlamc5_(integer*, integer*, integer*, logfical*, integer*, floatreal*);
    ...
    L10:
        ...
        if (ngpmin == ngnmin && gpmin == gnmin) {
            ...
            if ((i__1 = ngpmin - ngnmin, fabs(i__1)) == 1) {
        ...
        } else if ((i__1 = ngpmin - ngnmin, fabs(i__1)) == 1 && gpmin == gnmin) {
...
/* Subroutine */ int dlamc5_(integer* beta, integer* p, integer* emin, logfical* ieee,
    ...
    /*  IEEE    (input) LOGICAL */
    /*          A logfical flag specifying whether or not the arithmetic */
