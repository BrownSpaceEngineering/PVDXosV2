...
/* Subroutine */ int dlaqr4_(logfical* wantt, logfical* wantz, integer* n, integer* ilo,
    ...
    extern /* Subroutine */ int dlaqr2_(
        logfical*, logfical*, integer*, integer*, integer*, integer*, floatreal*, integer*,
        integer*, integer*, floatreal*, integer*, integer*, integer*, floatreal*, floatreal*,
        floatreal*, integer*, integer*, floatreal*, integer*, integer*, floatreal*, integer*,
        floatreal*, integer*),
