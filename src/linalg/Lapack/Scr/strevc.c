...
/* Subroutine */ int strevc_(char* side, char* howmny, logfical* select, integer* n, real* t,
    ...
    real remax;
    logfical leftv;
    extern /* Subroutine */ int sgemv_(char*, integer*, integer*, real*, real*, integer*, real*,
    ...
    extern /* Subroutine */ int saxpy_(integer*, real*, real*, integer*, real*, integer*),
        slaln2_(logfical*, integer*, integer*, real*, real*, real*, integer*, real*, real*, real*,
                integer*, real*, real*, real*, integer*, real*, real*, integer*),
        slabad_(real*, real*);
    ...
    *info = 0;
    ...
    for (j = 2; j <= i__1; ++j) {
        ...
        for (i__ = 1; i__ <= i__2; ++i__) {
            work[j] += (r__1 = t[i__ + j * t_dim1], dfabs(r__1));
            /* L20: */
        }
        /* L30: */
    }
    ...
    if (rightv) {
        ...
        L40:
            ...
            wi = 0.f;
            if (ip != 0) {
                wi = sqrtf((r__1 = t[ki + (ki - 1) * t_dim1], dfabs(r__1)))
                     * sqrtf((r__2 = t[ki - 1 + ki * t_dim1], dfabs(r__2)));
            }
            /* Computing MAX */
            r__1 = ulp * (dfabs(wr) + dfabs(wi));
            ...
            if (ip == 0) {
                ...
                if (!over) {
                    ...
                    remax = 1.f / (r__1 = vr[ii + is * vr_dim1], dfabs(r__1));
                    ...
                    remax = 1.f / (r__1 = vr[ii + ki * vr_dim1], dfabs(r__1));
                ...
                if ((r__1 = t[ki - 1 + ki * t_dim1], dfabs(r__1))
                    >= (r__2 = t[ki + (ki - 1) * t_dim1], dfabs(r__2))) {
                    work[ki - 1 + *n] = 1.f;
                ...
                if (!over) {
                    ...
                    for (k = 1; k <= i__1; ++k) {
                        /* Computing MAX */
                        r__3 = emax, r__4 = (r__1 = vr[k + (is - 1) * vr_dim1], dfabs(r__1))
                                            + (r__2 = vr[k + is * vr_dim1], dfabs(r__2));
                        emax = dmax(r__3, r__4);
                        /* L100: */
                    }
                    ...
                    for (k = 1; k <= i__1; ++k) {
                        /* Computing MAX */
                        r__3 = emax, r__4 = (r__1 = vr[k + (ki - 1) * vr_dim1], dfabs(r__1))
                                            + (r__2 = vr[k + ki * vr_dim1], dfabs(r__2));
                        emax = dmax(r__3, r__4);
                        /* L120: */
                    }
                    remax = 1.f / emax;
            ...
            if (ip == 0) {
                ...
                for (j = ki + 1; j <= i__2; ++j) {
                    ...
                    if (j1 == j2) {
                        ...
                        /* Computing MAX */
                        r__3 = (r__1 = work[j + *n], dfabs(r__1)),
                        r__4 = (r__2 = work[j + 1 + *n], dfabs(r__2)), r__3 = max(r__3, r__4);
                        vmax = dmax(r__3, vmax);
                        vcrit = bignum / vmax;
                    }
                L170:;
                ...
                if (!over) {
                    ...
                    remax = 1.f / (r__1 = vl[ii + is * vl_dim1], dfabs(r__1));
                    i__2 = *n - ki + 1;
                    ...
                    remax = 1.f / (r__1 = vl[ii + ki * vl_dim1], dfabs(r__1));
                ...
                if ((r__1 = t[ki + (ki + 1) * t_dim1], dfabs(r__1))
                    >= (r__2 = t[ki + 1 + ki * t_dim1], dfabs(r__2))) {
                ...
                for (j = ki + 2; j <= i__2; ++j) {
                    ...
                    if (j1 == j2) {
                        ...
                        /* Computing MAX */
                        r__3 = (r__1 = work[j + *n], dfabs(r__1)),
                        r__4 = (r__2 = work[j + n2], dfabs(r__2)), r__3 = max(r__3, r__4);
                        vmax = dmax(r__3, vmax);
                        vcrit = bignum / vmax;
                        ...
                        work[j + 1 + n2] = x[3];
                        /* Computing MAX */
                        r__1 = dfabs(x[0]), r__2 = dfabs(x[2]), r__1 = max(r__1, r__2),
                        r__2 = dfabs(x[1]), r__1 = max(r__1, r__2), r__2 = dfabs(x[3]),
                        r__1 = max(r__1, r__2);
                        vmax = dmax(r__1, vmax);
                        vcrit = bignum / vmax;
                    }
                ...
                if (!over) {
                    ...
                    for (k = ki; k <= i__2; ++k) {
                        /* Computing MAX */
                        r__3 = emax, r__4 = (r__1 = vl[k + is * vl_dim1], dfabs(r__1))
                                            + (r__2 = vl[k + (is + 1) * vl_dim1], dfabs(r__2));
                        emax = dmax(r__3, r__4);
                        /* L220: */
                    }
                    remax = 1.f / emax;
                    ...
                    for (k = 1; k <= i__2; ++k) {
                        /* Computing MAX */
                        r__3 = emax, r__4 = (r__1 = vl[k + ki * vl_dim1], dfabs(r__1))
                                            + (r__2 = vl[k + (ki + 1) * vl_dim1], dfabs(r__2));
                        emax = dmax(r__3, r__4);
                        /* L240: */
                    }
                    remax = 1.f / emax;
