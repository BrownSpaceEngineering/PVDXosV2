...
/* Subroutine */ int slahqr_(logfical* wantt, logfical* wantz, integer* n, integer* ilo,
    ...
    extern /* Subroutine */ int srot_(integer*, real*, integer*, real*, integer*, real*, real*),
...
L20:
    ...
    for (its = 0; its <= 30; ++its) {
        ...
        i__1 = l + 1;
        for (k = i__; k >= i__1; --k) {
            if ((r__1 = h__[k + (k - 1) * h_dim1], dfabs(r__1)) <= smlnum) {
                goto L40;
            }
            tst = (r__1 = h__[k - 1 + (k - 1) * h_dim1], dfabs(r__1))
                  + (r__2 = h__[k + k * h_dim1], dfabs(r__2));
            if (tst == 0.f) {
                if (k - 2 >= *ilo) {
                    tst += (r__1 = h__[k - 1 + (k - 2) * h_dim1], dfabs(r__1));
                }
                if (k + 1 <= *ihi) {
                    tst += (r__1 = h__[k + 1 + k * h_dim1], dfabs(r__1));
                }
            }
            ...
            if ((r__1 = h__[k + (k - 1) * h_dim1], dfabs(r__1)) <= ulp * tst) {
                /* Computing MAX */
                r__3 = (r__1 = h__[k + (k - 1) * h_dim1], dfabs(r__1)),
                r__4 = (r__2 = h__[k - 1 + k * h_dim1], dfabs(r__2));
                ab = dmax(r__3, r__4);
                /* Computing MIN */
                r__3 = (r__1 = h__[k + (k - 1) * h_dim1], dfabs(r__1)),
                r__4 = (r__2 = h__[k - 1 + k * h_dim1], dfabs(r__2));
                ba = dmin(r__3, r__4);
                /* Computing MAX */
                r__3 = (r__1 = h__[k + k * h_dim1], dfabs(r__1)),
                r__4 = (r__2 = h__[k - 1 + (k - 1) * h_dim1] - h__[k + k * h_dim1], dfabs(r__2));
                aa = dmax(r__3, r__4);
                /* Computing MIN */
                r__3 = (r__1 = h__[k + k * h_dim1], dfabs(r__1)),
                r__4 = (r__2 = h__[k - 1 + (k - 1) * h_dim1] - h__[k + k * h_dim1], dfabs(r__2));
    ...
    L40:
        ...
        if (its == 10) {
            ...
            s = (r__1 = h__[l + 1 + l * h_dim1], dfabs(r__1))
                + (r__2 = h__[l + 2 + (l + 1) * h_dim1], dfabs(r__2));
            ...
            s = (r__1 = h__[i__ + (i__ - 1) * h_dim1], dfabs(r__1))
        ...
        s = dfabs(h11) + dfabs(h12) + dfabs(h21) + dfabs(h22);
        if (s == 0.f) {
            rt1r = 0.f;
            rt1i = 0.f;
            rt2r = 0.f;
            ...
            if (det >= 0.f) {
                ...
                rt1r = tr + rtdisc;
                rt2r = tr - rtdisc;
                if ((r__1 = rt1r - h22, dfabs(r__1)) <= (r__2 = rt2r - h22, dfabs(r__2))) {
                    rt1r *= s;
                    rt2r = rt1r;
                } else {
                    rt2r *= s;
        ...
        for (m = i__ - 2; m >= i__1; --m) {
            ...
            s = (r__1 = h__[m + m * h_dim1] - rt2r, dfabs(r__1)) + dfabs(rt2i) + dfabs(h21s);
            ...
            s = dfabs(v[0]) + dfabs(v[1]) + dfabs(v[2]);
            v[0] /= s;
            v[1] /= s;
            v[2] /= s;
            if (m == l) {
            ...
            if ((r__1 = h__[m + (m - 1) * h_dim1], dfabs(r__1)) * (dfabs(v[1]) + dfabs(v[2]))
                <= ulp * dfabs(v[0])
                       * ((r__2 = h__[m - 1 + (m - 1) * h_dim1], dfabs(r__2))
                          + (r__3 = h__[m + m * h_dim1], dfabs(r__3))
                          + (r__4 = h__[m + 1 + (m + 1) * h_dim1], dfabs(r__4)))) {
                goto L60;
            }
            /* L50: */
        }
...
L150:
    ...
    if (l == i__) {
        ...
        slanv2_(&h__[i__ - 1 + (i__ - 1) * h_dim1], &h__[i__ - 1 + i__ * h_dim1],
