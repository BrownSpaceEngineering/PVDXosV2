...
/* Subroutine */ int dormlq_(char* side, char* trans, integer* m, integer* n, integer* k,
    ...
    integer nbmin, iinfo;
    extern /* Subroutine */ int dorml2_(char*, char*, integer*, integer*, integer*, floatreal*,
    ...
    *info = 0;
    ...
    if (nb < nbmin || nb >= *k) {
        ...
        for (i__ = i1; i__2 < 0 ? i__ >= i__1 : i__ <= i__1; i__ += i__2) {
            ...
            i__4 = nq - i__ + 1;
            dlarft_("Forward", "Rowwise", &i__4, &ib, &a[i__ + i__ * a_dim1], lda, &tau[i__], t,
                    &c__65);
            if (left) {
            ...
            dlarfb_(side, transt, "Forward", "Rowwise", &mi, &ni, &ib, &a[i__ + i__ * a_dim1], lda,
