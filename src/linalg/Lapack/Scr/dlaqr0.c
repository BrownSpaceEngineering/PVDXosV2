...
/* Subroutine */ int dlaqr0_(logfical* wantt, logfical* wantz, integer* n, integer* ilo,
    ...
    extern /* Subroutine */ int dlanv2_(floatreal*, floatreal*, floatreal*, floatreal*, floatreal*,
        ...
        dlaqr3_(logfical*, logfical*, integer*, integer*, integer*, integer*, floatreal*, integer*,
                integer*, integer*, floatreal*, integer*, integer*, integer*, floatreal*,
        ...
        dlaqr4_(logfical*, logfical*, integer*, integer*, integer*, floatreal*, integer*,
                ...
                integer*, integer*),
        dlaqr5_(logfical*, logfical*, integer*, integer*, integer*, integer*, integer*, floatreal*,
                floatreal*, floatreal*, integer*, integer*, integer*, floatreal*, integer*,
                floatreal*, integer*, floatreal*, integer*, integer*, floatreal*, integer*,
                integer*, floatreal*, integer*);
    integer nibble;
    extern /* Subroutine */ int dlahqr_(logfical*, logfical*, integer*, integer*, integer*,
        ...
        L20:
            ...
            if (nw < nwmax) {
                if (nw >= nh - 1) {
                    ...
                    kwtop = kbot - nw + 1;
                    if ((d__1 = h__[kwtop + (kwtop - 1) * h_dim1], fabs(d__1))
                        > (d__2 = h__[kwtop - 1 + (kwtop - 2) * h_dim1], fabs(d__2))) {
                        ++nw;
                    }
                }
            }
            ...
            if (ld == 0 || ld * 100 <= nw * nibble && kbot - ktop + 1 > min(nmin, nwmax)) {
                ...
                if (ndfl % 6 == 0) {
                    ...
                    for (i__ = kbot; i__ >= i__2; i__ += -2) {
                        ss = (d__1 = h__[i__ + (i__ - 1) * h_dim1], fabs(d__1))
                             + (d__2 = h__[i__ - 1 + (i__ - 2) * h_dim1], fabs(d__2));
                    ...
                    if (kbot - ks + 1 > ns) {
                        ...
                        for (k = kbot; k >= i__2; --k) {
                            ...
                            for (i__ = ks; i__ <= i__3; ++i__) {
                                if ((d__1 = wr[i__], fabs(d__1)) + (d__2 = wi[i__], fabs(d__2))
                                    < (d__3 = wr[i__ + 1], fabs(d__3))
                                          + (d__4 = wi[i__ + 1], fabs(d__4))) {
                                    sorted = FALSE_;
                ...
                if (kbot - ks + 1 == 2) {
                    if (wi[kbot] == 0.) {
                        if ((d__1 = wr[kbot] - h__[kbot + kbot * h_dim1], fabs(d__1))
                            < (d__2 = wr[kbot - 1] - h__[kbot + kbot * h_dim1], fabs(d__2))) {
                            wr[kbot - 1] = wr[kbot];
                        } else {
                            wr[kbot] = wr[kbot - 1];
                        }
