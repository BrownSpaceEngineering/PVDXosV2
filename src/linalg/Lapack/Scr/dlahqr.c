...
/* Subroutine */ int dlahqr_(logfical* wantt, logfical* wantz, integer* n, integer* ilo,
    ...
    extern /* Subroutine */ int drot_(integer*, floatreal*, integer*, floatreal*, integer*,
                                      floatreal*, floatreal*),
        dcopy_(integer*, floatreal*, integer*, floatreal*, integer*),
        dlanv2_(floatreal*, floatreal*, floatreal*, floatreal*, floatreal*, floatreal*, floatreal*,
...
L20:
    ...
    for (its = 0; its <= 30; ++its) {
        ...
        i__1 = l + 1;
        for (k = i__; k >= i__1; --k) {
            if ((d__1 = h__[k + (k - 1) * h_dim1], fabs(d__1)) <= smlnum) {
                goto L40;
            }
            tst = (d__1 = h__[k - 1 + (k - 1) * h_dim1], fabs(d__1))
                  + (d__2 = h__[k + k * h_dim1], fabs(d__2));
            if (tst == 0.) {
                if (k - 2 >= *ilo) {
                    tst += (d__1 = h__[k - 1 + (k - 2) * h_dim1], fabs(d__1));
                }
                if (k + 1 <= *ihi) {
                    tst += (d__1 = h__[k + 1 + k * h_dim1], fabs(d__1));
                }
            }
            ...
            if ((d__1 = h__[k + (k - 1) * h_dim1], fabs(d__1)) <= ulp * tst) {
                /* Computing MAX */
                d__3 = (d__1 = h__[k + (k - 1) * h_dim1], fabs(d__1)),
                d__4 = (d__2 = h__[k - 1 + k * h_dim1], fabs(d__2));
                ab = max(d__3, d__4);
                /* Computing MIN */
                d__3 = (d__1 = h__[k + (k - 1) * h_dim1], fabs(d__1)),
                d__4 = (d__2 = h__[k - 1 + k * h_dim1], fabs(d__2));
                ba = min(d__3, d__4);
                /* Computing MAX */
                d__3 = (d__1 = h__[k + k * h_dim1], fabs(d__1)),
                d__4 = (d__2 = h__[k - 1 + (k - 1) * h_dim1] - h__[k + k * h_dim1], fabs(d__2));
                aa = max(d__3, d__4);
                /* Computing MIN */
                d__3 = (d__1 = h__[k + k * h_dim1], fabs(d__1)),
                d__4 = (d__2 = h__[k - 1 + (k - 1) * h_dim1] - h__[k + k * h_dim1], fabs(d__2));
    ...
    L40:
        ...
        if (its == 10) {
            ...
            s = (d__1 = h__[l + 1 + l * h_dim1], fabs(d__1))
                + (d__2 = h__[l + 2 + (l + 1) * h_dim1], fabs(d__2));
            ...
            s = (d__1 = h__[i__ + (i__ - 1) * h_dim1], fabs(d__1))
        ...
        if (s == 0.) {
            ...
            if (det >= 0.) {
                ...
                rt1r = tr + rtdisc;
                rt2r = tr - rtdisc;
                if ((d__1 = rt1r - h22, fabs(d__1)) <= (d__2 = rt2r - h22, fabs(d__2))) {
                    rt1r *= s;
                    rt2r = rt1r;
                } else {
                    rt2r *= s;
        ...
        for (m = i__ - 2; m >= i__1; --m) {
            ...
            s = (d__1 = h__[m + m * h_dim1] - rt2r, fabs(d__1)) + fabs(rt2i) + fabs(h21s);
            ...
            if ((d__1 = h__[m + (m - 1) * h_dim1], fabs(d__1)) * (fabs(v[1]) + fabs(v[2]))
                <= ulp * fabs(v[0])
                       * ((d__2 = h__[m - 1 + (m - 1) * h_dim1], fabs(d__2))
                          + (d__3 = h__[m + m * h_dim1], fabs(d__3))
                          + (d__4 = h__[m + 1 + (m + 1) * h_dim1], fabs(d__4)))) {
                goto L60;
            }
            /* L50: */
        }
