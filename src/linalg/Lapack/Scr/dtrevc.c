...
static logfical c_false = FALSE_;
static integer c__1 = 1;
static floatreal c_b22 = 1.;
static floatreal c_b25 = 0.;
static integer c__2 = 2;
static logfical c_true = TRUE_;
...
/* Subroutine */ int dtrevc_(char* side, char* howmny, logfical* select, integer* n, floatreal* t,
    ...
    logfical pair;
    extern floatreal ddot_(integer*, floatreal*, integer*, floatreal*, integer*);
    logfical allv;
    integer ierr;
    ...
    extern /* Subroutine */ int dgemv_(char*, integer*, integer*, floatreal*, floatreal*, integer*,
                                       floatreal*, integer*, floatreal*, floatreal*, integer*);
    floatreal remax;
    extern /* Subroutine */ int dcopy_(integer*, floatreal*, integer*, floatreal*, integer*);
    logfical leftv, bothv;
    extern /* Subroutine */ int daxpy_(integer*, floatreal*, floatreal*, integer*, floatreal*,
                                       integer*);
    floatreal vcrit;
    logfical somev;
    floatreal xnorm;
    extern /* Subroutine */ int dlaln2_(logfical*, integer*, integer*, floatreal*, floatreal*,
    ...
    /*                  as indicated by the logfical array SELECT. */
    ...
    *info = 0;
    ...
    for (j = 2; j <= i__1; ++j) {
        ...
        for (i__ = 1; i__ <= i__2; ++i__) {
            work[j] += (d__1 = t[i__ + j * t_dim1], fabs(d__1));
            /* L20: */
        }
        /* L30: */
    }
    ...
    if (rightv) {
        ...
        L40:
            ...
            wi = 0.;
            if (ip != 0) {
                wi = sqrtf((d__1 = t[ki + (ki - 1) * t_dim1], fabs(d__1)))
                     * sqrtf((d__2 = t[ki - 1 + ki * t_dim1], fabs(d__2)));
            }
            /* Computing MAX */
            ...
            if (ip == 0) {
                ...
                for (j = ki - 1; j >= 1; --j) {
                    ...
                    if (j1 == j2) {
                        ...
                        dlaln2_(&c_false, &c__1, &c__1, &smin, &c_b22, &t[j + j * t_dim1], ldt,
                        ...
                        dlaln2_(&c_false, &c__2, &c__1, &smin, &c_b22, &t[j - 1 + (j - 1) * t_dim1],
                ...
                if (!over) {
                    ...
                    remax = 1. / (d__1 = vr[ii + is * vr_dim1], fabs(d__1));
                    ...
                    if (ki > 1) {
                        i__1 = ki - 1;
                        dgemv_("N", n, &i__1, &c_b22, &vr[vr_offset], ldvr, &work[*n + 1], &c__1,
                               &work[ki + *n], &vr[ki * vr_dim1 + 1], &c__1);
                    }

                    ii = idamax_(n, &vr[ki * vr_dim1 + 1], &c__1);
                    remax = 1. / (d__1 = vr[ii + ki * vr_dim1], fabs(d__1));
                ...
                if ((d__1 = t[ki - 1 + ki * t_dim1], fabs(d__1))
                    >= (d__2 = t[ki + (ki - 1) * t_dim1], fabs(d__2))) {
                    work[ki - 1 + *n] = 1.;
                ...
                for (j = ki - 2; j >= 1; --j) {
                    ...
                    if (j1 == j2) {
                        ...
                        dlaln2_(&c_false, &c__1, &c__2, &smin, &c_b22, &t[j + j * t_dim1], ldt,
                        ...
                        dlaln2_(&c_false, &c__2, &c__2, &smin, &c_b22, &t[j - 1 + (j - 1) * t_dim1],
                ...
                if (!over) {
                    ...
                    for (k = 1; k <= i__1; ++k) {
                        /* Computing MAX */
                        d__3 = emax, d__4 = (d__1 = vr[k + (is - 1) * vr_dim1], fabs(d__1))
                                            + (d__2 = vr[k + is * vr_dim1], fabs(d__2));
                        emax = max(d__3, d__4);
                        /* L100: */
                    }
                    ...
                    if (ki > 2) {
                        ...
                        i__1 = ki - 2;
                        dgemv_("N", n, &i__1, &c_b22, &vr[vr_offset], ldvr, &work[n2 + 1], &c__1,
                    ...
                    for (k = 1; k <= i__1; ++k) {
                        /* Computing MAX */
                        d__3 = emax, d__4 = (d__1 = vr[k + (ki - 1) * vr_dim1], fabs(d__1))
                                            + (d__2 = vr[k + ki * vr_dim1], fabs(d__2));
                        emax = max(d__3, d__4);
                        /* L120: */
                    }
                    remax = 1. / emax;
            ...
            if (ip == 0) {
                ...
                for (j = ki + 1; j <= i__2; ++j) {
                    ...
                    if (j1 == j2) {
                        ...
                        i__3 = j - ki - 1;
                        work[j + *n] -= ddot_(&i__3, &t[ki + 1 + j * t_dim1], &c__1,
                                              &work[ki + 1 + *n], &c__1);
                        ...
                        i__3 = j - ki - 1;
                        work[j + 1 + *n] -= ddot_(&i__3, &t[ki + 1 + (j + 1) * t_dim1], &c__1,
                                                  &work[ki + 1 + *n], &c__1);
                        ...
                        dlaln2_(&c_true, &c__2, &c__1, &smin, &c_b22, &t[j + j * t_dim1], ldt,
                                &c_b22, &c_b22, &work[j + *n], n, &wr, &c_b25, x, &c__2, &scale,
                                &xnorm, &ierr);
                        ...
                        /* Computing MAX */
                        d__3 = (d__1 = work[j + *n], fabs(d__1)),
                        d__4 = (d__2 = work[j + 1 + *n], fabs(d__2)), d__3 = max(d__3, d__4);
                        vmax = max(d__3, vmax);
                        vcrit = bignum / vmax;
                    }
                L170:;
                ...
                if (!over) {
                    ...
                    remax = 1. / (d__1 = vl[ii + is * vl_dim1], fabs(d__1));
                    i__2 = *n - ki + 1;
                    ...
                    if (ki < *n) {
                        i__2 = *n - ki;
                        dgemv_("N", n, &i__2, &c_b22, &vl[(ki + 1) * vl_dim1 + 1], ldvl,
                               &work[ki + 1 + *n], &c__1, &work[ki + *n], &vl[ki * vl_dim1 + 1],
                               &c__1);
                    }

                    ii = idamax_(n, &vl[ki * vl_dim1 + 1], &c__1);
                    remax = 1. / (d__1 = vl[ii + ki * vl_dim1], fabs(d__1));
                ...
                if ((d__1 = t[ki + (ki + 1) * t_dim1], fabs(d__1))
                    >= (d__2 = t[ki + 1 + ki * t_dim1], fabs(d__2))) {
                ...
                for (j = ki + 2; j <= i__2; ++j) {
                    ...
                    if (j1 == j2) {
                        ...
                        i__3 = j - ki - 2;
                        work[j + *n] -= ddot_(&i__3, &t[ki + 2 + j * t_dim1], &c__1,
                                              &work[ki + 2 + *n], &c__1);
                        i__3 = j - ki - 2;
                        work[j + n2] -= ddot_(&i__3, &t[ki + 2 + j * t_dim1], &c__1,
                                              &work[ki + 2 + n2], &c__1);
                        ...
                        d__1 = -wi;
                        dlaln2_(&c_false, &c__1, &c__2, &smin, &c_b22, &t[j + j * t_dim1], ldt,
                                &c_b22, &c_b22, &work[j + *n], n, &wr, &d__1, x, &c__2, &scale,
                                &xnorm, &ierr);
                        ...
                        /* Computing MAX */
                        d__3 = (d__1 = work[j + *n], fabs(d__1)),
                        d__4 = (d__2 = work[j + n2], fabs(d__2)), d__3 = max(d__3, d__4);
                        vmax = max(d__3, vmax);
                        vcrit = bignum / vmax;
                        ...
                        i__3 = j - ki - 2;
                        work[j + 1 + *n] -= ddot_(&i__3, &t[ki + 2 + (j + 1) * t_dim1], &c__1,
                                                  &work[ki + 2 + *n], &c__1);

                        i__3 = j - ki - 2;
                        work[j + 1 + n2] -= ddot_(&i__3, &t[ki + 2 + (j + 1) * t_dim1], &c__1,
                                                  &work[ki + 2 + n2], &c__1);
                        ...
                        d__1 = -wi;
                        dlaln2_(&c_true, &c__2, &c__2, &smin, &c_b22, &t[j + j * t_dim1], ldt,
                                &c_b22, &c_b22, &work[j + *n], n, &wr, &d__1, x, &c__2, &scale,
                                &xnorm, &ierr);
                        ...
                        work[j + 1 + n2] = x[3];
                        /* Computing MAX */
                        d__1 = fabs(x[0]), d__2 = fabs(x[2]), d__1 = max(d__1, d__2),
                        d__2 = fabs(x[1]), d__1 = max(d__1, d__2), d__2 = fabs(x[3]),
                        d__1 = max(d__1, d__2);
                        vmax = max(d__1, vmax);
                        vcrit = bignum / vmax;
                    }
                ...
                if (!over) {
                    ...
                    for (k = ki; k <= i__2; ++k) {
                        /* Computing MAX */
                        d__3 = emax, d__4 = (d__1 = vl[k + is * vl_dim1], fabs(d__1))
                                            + (d__2 = vl[k + (is + 1) * vl_dim1], fabs(d__2));
                        emax = max(d__3, d__4);
                        /* L220: */
                    }
                    remax = 1. / emax;
                    ...
                    if (ki < *n - 1) {
                        i__2 = *n - ki - 1;
                        dgemv_("N", n, &i__2, &c_b22, &vl[(ki + 2) * vl_dim1 + 1], ldvl,
                    ...
                    for (k = 1; k <= i__2; ++k) {
                        /* Computing MAX */
                        d__3 = emax, d__4 = (d__1 = vl[k + ki * vl_dim1], fabs(d__1))
                                            + (d__2 = vl[k + (ki + 1) * vl_dim1], fabs(d__2));
                        emax = max(d__3, d__4);
                        /* L240: */
                    }
                    remax = 1. / emax;
