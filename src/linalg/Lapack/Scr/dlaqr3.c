...
/* Subroutine */ int dlaqr3_(logfical* wantt, logfical* wantz, integer* n, integer* ktop,
    ...
    extern /* Subroutine */ int dlarf_(char*, integer*, integer*, floatreal*, integer*, floatreal*,
                                       floatreal*, integer*, floatreal*),
        dgemm_(char*, char*, integer*, integer*, integer*, floatreal*, floatreal*, integer*,
               floatreal*, integer*, floatreal*, floatreal*, integer*);
    logfical bulge;
    extern /* Subroutine */ int dcopy_(integer*, floatreal*, integer*, floatreal*, integer*);
    integer infqr, kwtop;
    extern /* Subroutine */ int dlanv2_(floatreal*, floatreal*, floatreal*, floatreal*, floatreal*,
                                        floatreal*, floatreal*, floatreal*, floatreal*, floatreal*),
        dlaqr4_(logfical*, logfical*, integer*, integer*, integer*, floatreal*, integer*,
                floatreal*, floatreal*, integer*, integer*, floatreal*, integer*, floatreal*,
                integer*, integer*),
        dlabad_(floatreal*, floatreal*);
    extern floatreal dlamch_(char*);
    extern /* Subroutine */ int dgehrd_(integer*, integer*, integer*, floatreal*, integer*,
                                        floatreal*, floatreal*, integer*, integer*),
        dlarfg_(integer*, floatreal*, floatreal*, integer*, floatreal*),
        dlahqr_(logfical*, logfical*, integer*, integer*, integer*, floatreal*, integer*,
                floatreal*, floatreal*, integer*, integer*, floatreal*, integer*, integer*),
    ...
    extern /* Subroutine */ int dlaset_(char*, integer*, integer*, floatreal*, floatreal*,
                                        floatreal*, integer*),
        dtrexc_(char*, integer*, floatreal*, integer*, floatreal*, integer*, integer*, integer*,
                floatreal*, integer*),
        dormhr_(char*, char*, integer*, integer*, integer*, integer*, floatreal*, integer*,
                floatreal*, floatreal*, integer*, floatreal*, integer*, integer*);
    logfical sorted;
    floatreal smlnum;
    integer lwkopt;
    ...
    *nd = 0;
    ...
    if (*kbot == kwtop) {
        ...
        *nd = 0;
        /* Computing MAX */
        d__2 = smlnum, d__3 = ulp * (d__1 = h__[kwtop + kwtop * h_dim1], fabs(d__1));
        if (fabs(s) <= max(d__2, d__3)) {
            *ns = 0;
            *nd = 1;
            if (kwtop > *ktop) {
...
L20:
    if (ilst <= *ns) {
        ...
        if (!bulge) {
            ...
            foo = (d__1 = t[*ns + *ns * t_dim1], fabs(d__1));
            if (foo == 0.) {
                foo = fabs(s);
            }
            /* Computing MAX */
            d__2 = smlnum, d__3 = ulp * foo;
            if ((d__1 = s * v[*ns * v_dim1 + 1], fabs(d__1)) <= max(d__2, d__3)) {
            ...
            foo = (d__3 = t[*ns + *ns * t_dim1], fabs(d__3))
                  + sqrtf((d__1 = t[*ns + (*ns - 1) * t_dim1], fabs(d__1)))
                        * sqrtf((d__2 = t[*ns - 1 + *ns * t_dim1], fabs(d__2)));
            if (foo == 0.) {
                foo = fabs(s);
            }
            /* Computing MAX */
            d__3 = (d__1 = s * v[*ns * v_dim1 + 1], fabs(d__1)),
            d__4 = (d__2 = s * v[(*ns - 1) * v_dim1 + 1], fabs(d__2));
            /* Computing MAX */
    ...
    L40:
        if (k <= kend) {
            if (k == i__ + 1) {
                evi = (d__1 = t[i__ + i__ * t_dim1], fabs(d__1));
            } else {
                evi = (d__3 = t[i__ + i__ * t_dim1], fabs(d__3))
                      + sqrtf((d__1 = t[i__ + 1 + i__ * t_dim1], fabs(d__1)))
                            * sqrtf((d__2 = t[i__ + (i__ + 1) * t_dim1], fabs(d__2)));
            }

            if (k == kend) {
                evk = (d__1 = t[k + k * t_dim1], fabs(d__1));
            } else if (t[k + 1 + k * t_dim1] == 0.) {
                evk = (d__1 = t[k + k * t_dim1], fabs(d__1));
            } else {
                evk = (d__3 = t[k + k * t_dim1], fabs(d__3))
                      + sqrtf((d__1 = t[k + 1 + k * t_dim1], fabs(d__1)))
                            * sqrtf((d__2 = t[k + (k + 1) * t_dim1], fabs(d__2)));
            }
