...
/* Subroutine */ int dlabrd_(integer* m, integer* n, integer* nb, floatreal* a, integer* lda,
    ...
    extern /* Subroutine */ int dscal_(integer*, floatreal*, floatreal*, integer*),
        dgemv_(char*, integer*, integer*, floatreal*, floatreal*, integer*, floatreal*, integer*,
    ...
    if (*m >= *n) {
        ...
        for (i__ = 1; i__ <= i__1; ++i__) {
            ...
            i__2 = *m - i__ + 1;
            i__3 = i__ - 1;
            dgemv_("No transpose", &i__2, &i__3, &c_b4, &a[i__ + a_dim1], lda, &y[i__ + y_dim1],
                   ldy, &c_b5, &a[i__ + i__ * a_dim1], &c__1);
            i__2 = *m - i__ + 1;
            i__3 = i__ - 1;
            dgemv_("No transpose", &i__2, &i__3, &c_b4, &x[i__ + x_dim1], ldx, &a[i__ * a_dim1 + 1],
                   &c__1, &c_b5, &a[i__ + i__ * a_dim1], &c__1);
            ...
            if (i__ < *n) {
                ...
                i__2 = *m - i__;
                i__3 = *n - i__;
                dgemv_("No transpose", &i__2, &i__3, &c_b5, &a[i__ + 1 + (i__ + 1) * a_dim1], lda,
                       &a[i__ + (i__ + 1) * a_dim1], lda, &c_b16, &x[i__ + 1 + i__ * x_dim1],
                       &c__1);
                i__2 = *n - i__;
        ...
        for (i__ = 1; i__ <= i__1; ++i__) {
            ...
            i__2 = *n - i__ + 1;
            i__3 = i__ - 1;
            dgemv_("No transpose", &i__2, &i__3, &c_b4, &y[i__ + y_dim1], ldy, &a[i__ + a_dim1],
                   lda, &c_b5, &a[i__ + i__ * a_dim1], lda);
            i__2 = i__ - 1;
            i__3 = *n - i__ + 1;
            dgemv_("Transpose", &i__2, &i__3, &c_b4, &a[i__ * a_dim1 + 1], lda, &x[i__ + x_dim1],
                   ldx, &c_b5, &a[i__ + i__ * a_dim1], lda);
