...
/* Subroutine */ int slaqr3_(logfical* wantt, logfical* wantz, integer* n, integer* ktop,
    ...
    logfical bulge;
    extern /* Subroutine */ int slarf_(char*, integer*, integer*, real*, integer*, real*, real*,
                                       integer*, real*),
        sgemm_(char*, char*, integer*, integer*, integer*, real*, real*, integer*, real*, integer*,
               real*, real*, integer*);
    integer infqr;
    extern /* Subroutine */ int scopy_(integer*, real*, integer*, real*, integer*);
    integer kwtop;
    extern /* Subroutine */ int slanv2_(real*, real*, real*, real*, real*, real*, real*, real*,
                                        real*, real*),
        slaqr4_(logfical*, logfical*, integer*, integer*, integer*, real*, integer*, real*, real*,
                integer*, integer*, real*, integer*, real*, integer*, integer*),
        slabad_(real*, real*);
    extern floatreal slamch_(char*);
    extern /* Subroutine */ int sgehrd_(integer*, integer*, integer*, real*, integer*, real*, real*,
                                        integer*, integer*);
    real safmin;
    extern integer ilaenv_(integer*, char*, char*, integer*, integer*, integer*, integer*);
    real safmax;
    extern /* Subroutine */ int slarfg_(integer*, real*, real*, integer*, real*),
        slahqr_(logfical*, logfical*, integer*, integer*, integer*, real*, integer*, real*, real*,
                integer*, integer*, real*, integer*, integer*),
        slacpy_(char*, integer*, integer*, real*, integer*, real*, integer*),
        slaset_(char*, integer*, integer*, real*, real*, real*, integer*);
    logfical sorted;
    extern /* Subroutine */ int strexc_(char*, integer*, real*, integer*, real*, integer*, integer*,
                                        integer*, real*, integer*),
        sormhr_(char*, char*, integer*, integer*, integer*, integer*, real*, integer*, real*, real*,
    ...
    *nd = 0;
    ...
    if (*kbot == kwtop) {
        ...
        *nd = 0;
        /* Computing MAX */
        r__2 = smlnum, r__3 = ulp * (r__1 = h__[kwtop + kwtop * h_dim1], dfabs(r__1));
        if (dfabs(s) <= dmax(r__2, r__3)) {
            *ns = 0;
            *nd = 1;
            if (kwtop > *ktop) {
...
L20:
    if (ilst <= *ns) {
        ...
        if (!bulge) {
            ...
            foo = (r__1 = t[*ns + *ns * t_dim1], dfabs(r__1));
            if (foo == 0.f) {
                foo = dfabs(s);
            }
            /* Computing MAX */
            r__2 = smlnum, r__3 = ulp * foo;
            if ((r__1 = s * v[*ns * v_dim1 + 1], dfabs(r__1)) <= dmax(r__2, r__3)) {
            ...
            foo = (r__3 = t[*ns + *ns * t_dim1], dfabs(r__3))
                  + sqrtf((r__1 = t[*ns + (*ns - 1) * t_dim1], dfabs(r__1)))
                        * sqrtf((r__2 = t[*ns - 1 + *ns * t_dim1], dfabs(r__2)));
            if (foo == 0.f) {
                foo = dfabs(s);
            }
            /* Computing MAX */
            r__3 = (r__1 = s * v[*ns * v_dim1 + 1], dfabs(r__1)),
            r__4 = (r__2 = s * v[(*ns - 1) * v_dim1 + 1], dfabs(r__2));
            /* Computing MAX */
    ...
    L40:
        if (k <= kend) {
            if (k == i__ + 1) {
                evi = (r__1 = t[i__ + i__ * t_dim1], dfabs(r__1));
            } else {
                evi = (r__3 = t[i__ + i__ * t_dim1], dfabs(r__3))
                      + sqrtf((r__1 = t[i__ + 1 + i__ * t_dim1], dfabs(r__1)))
                            * sqrtf((r__2 = t[i__ + (i__ + 1) * t_dim1], dfabs(r__2)));
            }

            if (k == kend) {
                evk = (r__1 = t[k + k * t_dim1], dfabs(r__1));
            } else if (t[k + 1 + k * t_dim1] == 0.f) {
                evk = (r__1 = t[k + k * t_dim1], dfabs(r__1));
            } else {
                evk = (r__3 = t[k + k * t_dim1], dfabs(r__3))
                      + sqrtf((r__1 = t[k + 1 + k * t_dim1], dfabs(r__1)))
                            * sqrtf((r__2 = t[k + (k + 1) * t_dim1], dfabs(r__2)));
            }
...
L60:
    if (i__ >= infqr + 1) {
        if (i__ == infqr + 1) {
            ...
            dd = t[i__ + i__ * t_dim1];
            slanv2_(&aa, &bb, &cc, &dd, &sr[kwtop + i__ - 2], &si[kwtop + i__ - 2],
