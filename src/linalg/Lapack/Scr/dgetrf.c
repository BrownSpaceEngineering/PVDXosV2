...
/* Subroutine */ int dgetrf_(integer* m, integer* n, floatreal* a, integer* lda, integer* ipiv,
    ...
    extern /* Subroutine */ int dgemm_(char*, char*, integer*, integer*, integer*, floatreal*,
                                       ...
                                       floatreal*, integer*);
    integer iinfo;
    extern /* Subroutine */ int dtrsm_(char*, char*, char*, char*, integer*, integer*, floatreal*,
                                       floatreal*, integer*, floatreal*, integer*),
        dgetf2_(integer*, integer*, floatreal*, integer*, integer*, integer*),
        xerbla_(char*, integer*);
    extern integer ilaenv_(integer*, char*, char*, integer*, integer*, integer*, integer*);
    extern /* Subroutine */ int dlaswp_(integer*, floatreal*, integer*, integer*, integer*,
                                        integer*, integer*);
        ...
        for (j = 1; i__2 < 0 ? j >= i__1 : j <= i__1; j += i__2) {
            ...
            if (j + jb <= *n) {
                ...
                if (j + jb <= *m) {
                    ...
                    i__3 = *m - j - jb + 1;
                    i__4 = *n - j - jb + 1;
                    dgemm_("No transpose", "No transpose", &i__3, &i__4, &jb, &c_b19,
