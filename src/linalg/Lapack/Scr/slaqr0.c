...
/* Subroutine */ int slaqr0_(logfical* wantt, logfical* wantz, integer* n, integer* ilo,
    ...
    extern /* Subroutine */ int slanv2_(real*, real*, real*, real*, real*, real*, real*, real*,
                                        real*, real*),
        slaqr3_(logfical*, logfical*, integer*, integer*, integer*, integer*, real*, integer*,
                integer*, integer*, real*, integer*, integer*, integer*, real*, real*, real*,
                integer*, integer*, real*, integer*, integer*, real*, integer*, real*, integer*),
        ...
        slaqr5_(logfical*, logfical*, integer*, integer*, integer*, integer*, integer*, real*,
                real*, real*, integer*, integer*, integer*, real*, integer*, real*, integer*, real*,
    ...
    *info = 0;
    ...
    if (*n <= 11) {
        ...
        lwkopt = 1;
        if (*lwork != -1) {
            slahqr_(wantt, wantz, n, ilo, ihi, &h__[h_offset], ldh, &wr[1], &wi[1], iloz, ihiz,
        ...
        *info = 0;
        ...
        i__1 = nwr + 1;
        slaqr3_(wantt, wantz, n, ilo, ihi, &i__1, &h__[h_offset], ldh, iloz, ihiz, &z__[z_offset],
        ...
        L20:
            ...
            if (nw < nwmax) {
                if (nw >= nh - 1) {
                    ...
                    kwtop = kbot - nw + 1;
                    if ((r__1 = h__[kwtop + (kwtop - 1) * h_dim1], dfabs(r__1))
                        > (r__2 = h__[kwtop - 1 + (kwtop - 2) * h_dim1], dfabs(r__2))) {
                        ++nw;
                    }
                }
            }
            ...
            slaqr3_(wantt, wantz, n, &ktop, &kbot, &nw, &h__[h_offset], ldh, iloz, ihiz,
            ...
            if (ld == 0 || ld * 100 <= nw * nibble && kbot - ktop + 1 > min(nmin, nwmax)) {
                ...
                if (ndfl % 6 == 0) {
                    ...
                    for (i__ = kbot; i__ >= i__2; i__ += -2) {
                        ss = (r__1 = h__[i__ + (i__ - 1) * h_dim1], dfabs(r__1))
                             + (r__2 = h__[i__ - 1 + (i__ - 2) * h_dim1], dfabs(r__2));
                    ...
                    if (kbot - ks + 1 <= ns / 2) {
                        ...
                        if (ns > nmin) {
                            slaqr4_(&c_false, &c_false, &ns, &c__1, &ns, &h__[kt + h_dim1], ldh,
                                    &wr[ks], &wi[ks], &c__1, &c__1, zdum, &c__1, &work[1], lwork,
                                    &inf);
                        } else {
                            slahqr_(&c_false, &c_false, &ns, &c__1, &ns, &h__[kt + h_dim1], ldh,
                        ...
                        if (ks >= kbot) {
                            ...
                            slanv2_(&aa, &bb, &cc, &dd, &wr[kbot - 1], &wi[kbot - 1], &wr[kbot],
                                    &wi[kbot], &cs, &sn);
                            ks = kbot - 1;
                        }
                    }
                    ...
                    if (kbot - ks + 1 > ns) {
                        ...
                        for (k = kbot; k >= i__2; --k) {
                            ...
                            for (i__ = ks; i__ <= i__3; ++i__) {
                                if ((r__1 = wr[i__], dfabs(r__1)) + (r__2 = wi[i__], dfabs(r__2))
                                    < (r__3 = wr[i__ + 1], dfabs(r__3))
                                          + (r__4 = wi[i__ + 1], dfabs(r__4))) {
                                    sorted = FALSE_;
                ...
                if (kbot - ks + 1 == 2) {
                    if (wi[kbot] == 0.f) {
                        if ((r__1 = wr[kbot] - h__[kbot + kbot * h_dim1], dfabs(r__1))
                            < (r__2 = wr[kbot - 1] - h__[kbot + kbot * h_dim1], dfabs(r__2))) {
                            wr[kbot - 1] = wr[kbot];
                        } else {
                            wr[kbot] = wr[kbot - 1];
                        }
                ...
                slaqr5_(wantt, wantz, &kacc22, n, &ktop, &kbot, &ns, &wr[ks], &wi[ks],
