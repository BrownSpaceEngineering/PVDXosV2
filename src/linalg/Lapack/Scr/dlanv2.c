...
/* Subroutine */ int dlanv2_(floatreal* a, floatreal* b, floatreal* c__, floatreal* d__,
    ...
    /* Local variables */
    floatreal p, z__, aa, bb, cc, dd, cs1, sn1, sab, sac, eps, tau, temp, scale, bcmax, bcmis,
        sigma;
            ...
            if (*c__ != 0.) {
                if (*b != 0.) {
                    if (d_sign(&c_b4, b) == d_sign(&c_b4, c__)) {
                        ...
                        d__1 = sab * sac;
                        p = d_sign(&d__1, c__);
                        tau = 1. / sqrtf((d__1 = *b + *c__, fabs(d__1)));
                        *a = temp + p;
                        *d__ = temp - p;
                        *b -= *c__;
                        *c__ = 0.;
...
L10:
    ...
    *rt2r = *d__;
    if (*c__ == 0.) {
        ...
        *rt1i = sqrtf((fabs(*b))) * sqrtf((fabs(*c__)));
        *rt2i = -(*rt1i);
    }
    return 0;
