...
/* Subroutine */ int slaexc_(logfical* wantq, integer* n, real* t, integer* ldt, real* q,
    ...
    extern /* Subroutine */ int slanv2_(real*, real*, real*, real*, real*, real*, real*, real*,
                                        real*, real*),
        slasy2_(logfical*, logfical*, integer*, integer*, integer*, real*, integer*, real*,
    ...
    real thresh;
    extern /* Subroutine */ int slarfx_(char*, integer*, integer*, real*, real*, real*, integer*,
                                        real*);
    real smlnum;
    ...
    *info = 0;
    ...
    L10:
        ...
        /* Computing MAX */
        r__2 = dfabs(d__[2]), r__3 = dfabs(d__[6]), r__2 = max(r__2, r__3),
        r__3 = (r__1 = d__[10] - t11, dfabs(r__1));
    ...
    L20:
        ...
        /* Computing MAX */
        r__2 = dfabs(d__[1]), r__3 = dfabs(d__[2]), r__2 = max(r__2, r__3),
        r__3 = (r__1 = d__[0] - t33, dfabs(r__1));
        if (dmax(r__2, r__3) > thresh) {
            goto L50;
        }
    ...
    L30:
        ...
        /* Computing MAX */
        r__1 = dfabs(d__[2]), r__2 = dfabs(d__[6]), r__1 = max(r__1, r__2), r__2 = dfabs(d__[3]),
        r__1 = max(r__1, r__2), r__2 = dfabs(d__[7]);
