...
/* Subroutine */ int dgeev_(char* jobvl, char* jobvr, integer* n, floatreal* a, integer* lda,
    ...
    floatreal anrm;
    integer ierr, itau;
    extern /* Subroutine */ int drot_(integer*, floatreal*, integer*, floatreal*, integer*,
                                      floatreal*, floatreal*);
    integer iwrk, nout;
    ...
    extern /* Subroutine */ int dlabad_(floatreal*, floatreal*),
        dgebak_(char*, char*, integer*, integer*, integer*, floatreal*, integer*, floatreal*,
                integer*, integer*),
        dgebal_(char*, integer*, floatreal*, integer*, integer*, integer*, floatreal*, integer*);
    logfical scalea;
    extern floatreal dlamch_(char*);
    floatreal cscale;
    extern floatreal dlange_(char*, integer*, integer*, floatreal*, integer*, floatreal*);
    ...
    extern /* Subroutine */ int dlacpy_(char*, integer*, integer*, floatreal*, integer*, floatreal*,
                                        integer*),
        dlartg_(floatreal*, floatreal*, floatreal*, floatreal*, floatreal*),
        xerbla_(char*, integer*);
    logfical select[1];
    extern integer ilaenv_(integer*, char*, char*, integer*, integer*, integer*, integer*);
    floatreal bignum;
    extern /* Subroutine */ int dorghr_(integer*, integer*, integer*, floatreal*, integer*,
                                        floatreal*, floatreal*, integer*, integer*),
        dhseqr_(char*, char*, integer*, integer*, integer*, floatreal*, integer*, floatreal*,
                floatreal*, floatreal*, integer*, floatreal*, integer*, integer*),
        dtrevc_(char*, char*, logfical*, integer*, floatreal*, integer*, floatreal*, integer*,
                floatreal*, integer*, integer*, integer*, floatreal*, integer*);
    integer minwrk, maxwrk;
    logfical wantvl;
    floatreal smlnum;
    integer hswork;
    logfical lquery, wantvr;
    ...
    *info = 0;
    ...
    if (*info == 0) {
        if (*n == 0) {
            ...
            if (wantvl) {
                ...
                /* Computing MAX */
                i__1 = maxwrk,
                i__2 = (*n << 1) + (*n - 1) * ilaenv_(&c__1, "DORGHR", " ", n, &c__1, n, &c_n1);
                ...
                minwrk = *n * 3;
                dhseqr_("E", "N", n, &c__1, n, &a[a_offset], lda, &wr[1], &wi[1], &vr[vr_offset],
                        ldvr, &work[1], &c_n1, info);
                hswork = (integer)work[1];
                /* Computing MAX */
                i__1 = maxwrk, i__2 = *n + 1, i__1 = max(i__1, i__2), i__2 = *n + hswork;
    ...
    if (wantvl) {
        ...
        *(unsigned char*)side = 'R';
        ...
        iwrk = itau;
        i__1 = *lwork - iwrk + 1;
        dhseqr_("E", "N", n, &ilo, &ihi, &a[a_offset], lda, &wr[1], &wi[1], &vr[vr_offset], ldvr,
                &work[iwrk], &i__1, info);
    }
    ...
    if (wantvl || wantvr) {
        ...
        dtrevc_(side, "B", select, n, &a[a_offset], lda, &vl[vl_offset], ldvl, &vr[vr_offset], ldvr,
