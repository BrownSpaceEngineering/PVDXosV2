...
/* Subroutine */ int dlasq2_(integer* n, floatreal* z__, integer* info) {
    ...
    integer iinfo, ttype;
    extern /* Subroutine */ int dlasq3_(integer*, integer*, floatreal*, integer*, floatreal*,
                                        floatreal*, floatreal*, floatreal*, integer*, integer*,
                                        integer*, logfical*, integer*, floatreal*, floatreal*,
    ...
    extern /* Subroutine */ int dlasrt_(char*, integer*, floatreal*, integer*);
    ...
    /*  fabsence of denormalization, underflow and overflow. */
    ...
    /*  Note : DLASQ2 defines a logfical variable, IEEE, which is true */
