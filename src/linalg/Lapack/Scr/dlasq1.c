...
/* Subroutine */ int dlasq1_(integer* n, floatreal* d__, floatreal* e, floatreal* work,
    ...
    integer i__;
    floatreal eps;
    extern /* Subroutine */ int dlas2_(floatreal*, floatreal*, floatreal*, floatreal*, floatreal*);
    floatreal scale;
    integer iinfo;
    floatreal sigmn;
    ...
    extern /* Subroutine */ int dlascl_(char*, integer*, integer*, floatreal*, floatreal*, integer*,
                                        integer*, floatreal*, integer*, integer*);
    floatreal safmin;
    extern /* Subroutine */ int xerbla_(char*, integer*),
        dlasrt_(char*, integer*, floatreal*, integer*);
    ...
    /*  are computed to high relative accuracy, in the fabsence of */
