...
/* Subroutine */ int dlarft_(char* direct, char* storev, integer* n, integer* k, floatreal* v,
    ...
    integer lastv;
    extern /* Subroutine */ int dtrmv_(char*, char*, char*, integer*, floatreal*, integer*,
                                       floatreal*, integer*);
            ...
            if (tau[i__] == 0.) {
                ...
                if (lsame_(storev, "C")) {
                    ...
                    dgemv_("Transpose", &i__2, &i__3, &d__1, &v[i__ + v_dim1], ldv,
                           &v[i__ + i__ * v_dim1], &c__1, &c_b8, &t[i__ * t_dim1 + 1], &c__1);
                } else {
                    /*                 Skip any trailing zeros. */
                    i__2 = i__ + 1;
                    for (lastv = *n; lastv >= i__2; --lastv) {
                    ...
                    dgemv_("No transpose", &i__2, &i__3, &d__1, &v[i__ * v_dim1 + 1], ldv,
                           &v[i__ + i__ * v_dim1], ldv, &c_b8, &t[i__ * t_dim1 + 1], &c__1);
                }
                ...
                if (i__ < *k) {
                    if (lsame_(storev, "C")) {
                        ...
                        dgemv_("Transpose", &i__1, &i__2, &d__1, &v[j + (i__ + 1) * v_dim1], ldv,
                               &v[j + i__ * v_dim1], &c__1, &c_b8, &t[i__ + 1 + i__ * t_dim1],
                               &c__1);
                        ...
                        dgemv_("No transpose", &i__1, &i__2, &d__1, &v[i__ + 1 + j * v_dim1], ldv,
                               &v[i__ + j * v_dim1], ldv, &c_b8, &t[i__ + 1 + i__ * t_dim1], &c__1);
