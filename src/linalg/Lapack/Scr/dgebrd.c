...
/* Subroutine */ int dgebrd_(integer* m, integer* n, floatreal* a, integer* lda, floatreal* d__,
    ...
    extern /* Subroutine */ int dgebd2_(integer*, integer*, floatreal*, integer*, floatreal*,
                                        floatreal*, floatreal*, floatreal*, floatreal*, integer*),
        dlabrd_(integer*, integer*, integer*, floatreal*, integer*, floatreal*, floatreal*,
                floatreal*, floatreal*, floatreal*, integer*, floatreal*, integer*),
    ...
    *info = 0;
    ...
    for (i__ = 1; i__2 < 0 ? i__ >= i__1 : i__ <= i__1; i__ += i__2) {
        ...
        i__3 = *m - i__ - nb + 1;
        i__4 = *n - i__ - nb + 1;
        dgemm_("No transpose", "Transpose", &i__3, &i__4, &nb, &c_b21, &a[i__ + nb + i__ * a_dim1],
               lda, &work[ldwrkx * nb + nb + 1], &ldwrky, &c_b22,
               &a[i__ + nb + (i__ + nb) * a_dim1], lda);
        i__3 = *m - i__ - nb + 1;
        i__4 = *n - i__ - nb + 1;
        dgemm_("No transpose", "No transpose", &i__3, &i__4, &nb, &c_b21, &work[nb + 1], &ldwrkx,
