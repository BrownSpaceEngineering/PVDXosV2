...
/* Subroutine */ int dbdsqr_(char* uplo, integer* n, integer* ncvt, integer* nru, integer* ncc,
    ...
    /* Builtin functions */
    float pow_dd(floatreal*, floatreal*), sqrtf(floatreal), d_sign(floatreal*, floatreal*);
    ...
    extern /* Subroutine */ int drot_(integer*, floatreal*, integer*, floatreal*, integer*,
                                      floatreal*, floatreal*),
        dlas2_(floatreal*, floatreal*, floatreal*, floatreal*, floatreal*),
        dscal_(integer*, floatreal*, floatreal*, integer*);
    extern logfical lsame_(char*, char*);
    floatreal oldcs;
    extern /* Subroutine */ int dlasr_(char*, char*, char*, integer*, integer*, floatreal*,
                                       floatreal*, floatreal*, integer*);
    integer oldll;
    floatreal shift, sigmn, oldsn;
    extern /* Subroutine */ int dswap_(integer*, floatreal*, integer*, floatreal*, integer*);
    integer maxit;
    floatreal sminl, sigmx;
    logfical lower;
    extern /* Subroutine */ int dlasq1_(integer*, floatreal*, floatreal*, floatreal*, integer*),
        dlasv2_(floatreal*, floatreal*, floatreal*, floatreal*, floatreal*, floatreal*, floatreal*,
                floatreal*, floatreal*);
    extern floatreal dlamch_(char*);
    extern /* Subroutine */ int dlartg_(floatreal*, floatreal*, floatreal*, floatreal*, floatreal*),
    ...
    /*          If it is negative, fabs(TOLMUL*EPS*sigma_max) is the */
    /*             desired fabsolute accuracy in the computed singular */
    /*             values (corresponds to relative accuracy */
    /*             fabs(TOLMUL*EPS) in the largest singular value. */
    /*          fabs(TOLMUL) should be between 1 and 1/EPS, and preferably */
    ...
    *info = 0;
    ...
    /*     singular values to fabsolute accuracy ABS(TOL)*norm(input matrix)) */
...
L60:
    ...
    for (lll = 1; lll <= i__1; ++lll) {
        ll = m - lll;
        fabss = (d__1 = d__[ll], fabs(d__1));
        fabse = (d__1 = e[ll], fabs(d__1));
        if (tol < 0. && fabss <= thresh) {
            d__[ll] = 0.;
        }
        if (fabse <= thresh) {
            goto L80;
...
L90:
    ...
    if (idir == 1) {
        ...
        if ((d__2 = e[m - 1], fabs(d__2)) <= fabs(tol) * (d__1 = d__[m], fabs(d__1))
            || tol < 0. && (d__3 = e[m - 1], fabs(d__3)) <= thresh) {
            e[m - 1] = 0.;
            goto L60;
        }
        ...
        if ((d__2 = e[ll], fabs(d__2)) <= fabs(tol) * (d__1 = d__[ll], fabs(d__1))
            || tol < 0. && (d__3 = e[ll], fabs(d__3)) <= thresh) {
            e[ll] = 0.;
            goto L60;
        }
