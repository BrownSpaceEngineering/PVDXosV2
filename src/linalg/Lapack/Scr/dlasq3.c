...
/* Subroutine */ int dlasq3_(integer* i0, integer* n0, floatreal* z__, integer* pp,
    ...
    integer n0in, ipn4;
    floatreal tol2, temp;
    extern /* Subroutine */ int dlasq4_(integer*, integer*, floatreal*, integer*, integer*,
                                        floatreal*, floatreal*, floatreal*, floatreal*, floatreal*,
                                        floatreal*, floatreal*, integer*, floatreal*),
        dlasq5_(integer*, integer*, floatreal*, integer*, floatreal*, floatreal*, floatreal*,
                floatreal*, floatreal*, floatreal*, floatreal*, logfical*),
        dlasq6_(integer*, integer*, floatreal*, integer*, floatreal*, floatreal*, floatreal*,
                floatreal*, floatreal*, floatreal*);
    extern floatreal dlamch_(char*);
    extern logfical disnan_(floatreal*);
