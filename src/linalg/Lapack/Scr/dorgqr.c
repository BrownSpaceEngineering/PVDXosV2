...
/* Subroutine */ int dorgqr_(integer* m, integer* n, integer* k, floatreal* a, integer* lda,
    ...
    extern /* Subroutine */ int dorg2r_(integer*, integer*, integer*, floatreal*, integer*,
    ...
    if (kk > 0) {
        ...
        for (i__ = ki + 1; i__1 < 0 ? i__ >= 1 : i__ <= 1; i__ += i__1) {
            ...
            if (i__ + ib <= *n) {
                ...
                i__2 = *m - i__ + 1;
                dlarft_("Forward", "Columnwise", &i__2, &ib, &a[i__ + i__ * a_dim1], lda, &tau[i__],
                        &work[1], &ldwork);
                ...
                i__2 = *m - i__ + 1;
                i__3 = *n - i__ - ib + 1;
                dlarfb_("Left", "No transpose", "Forward", "Columnwise", &i__2, &i__3, &ib,
