...
/* Subroutine */ int dhseqr_(char* job, char* compz, integer* n, integer* ilo, integer* ihi,
    ...
    logfical initz;
    floatreal workl[49];
    logfical wantt, wantz;
    extern /* Subroutine */ int dlaqr0_(
        logfical*, logfical*, integer*, integer*, integer*, floatreal*, integer*, floatreal*,
        floatreal*, integer*, integer*, floatreal*, integer*, floatreal*, integer*, integer*),
