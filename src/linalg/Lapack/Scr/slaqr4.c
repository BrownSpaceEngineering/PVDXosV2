...
/* Subroutine */ int slaqr4_(logfical* wantt, logfical* wantz, integer* n, integer* ilo,
    ...
    extern /* Subroutine */ int slaqr2_(
        logfical*, logfical*, integer*, integer*, integer*, integer*, real*, integer*, integer*,
        integer*, real*, integer*, integer*, integer*, real*, real*, real*, integer*, integer*,
    ...
    *info = 0;
    ...
    if (*n <= 11) {
        ...
        *info = 0;
        ...
        i__1 = nwr + 1;
        slaqr2_(wantt, wantz, n, ilo, ihi, &i__1, &h__[h_offset], ldh, iloz, ihiz, &z__[z_offset],
        ...
        L20:
            ...
            slaqr2_(wantt, wantz, n, &ktop, &kbot, &nw, &h__[h_offset], ldh, iloz, ihiz,
