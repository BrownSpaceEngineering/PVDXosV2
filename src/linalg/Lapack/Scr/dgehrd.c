...
/* Subroutine */ int dgehrd_(integer* n, integer* ilo, integer* ihi, floatreal* a, integer* lda,
    ...
    extern /* Subroutine */ int dtrmm_(char*, char*, char*, char*, integer*, integer*, floatreal*,
        ...
        daxpy_(integer*, floatreal*, floatreal*, integer*, floatreal*, integer*),
        dgehd2_(integer*, integer*, integer*, floatreal*, integer*, floatreal*, floatreal*,
                integer*),
        dlahr2_(integer*, integer*, integer*, floatreal*, integer*, floatreal*, floatreal*,
                integer*, floatreal*, integer*),
        dlarfb_(char*, char*, char*, char*, integer*, integer*, integer*, floatreal*, integer*,
                floatreal*, integer*, floatreal*, integer*, floatreal*, integer*),
    ...
    *info = 0;
    ...
    if (nb > 1 && nb < nh) {
        ...
        if (nx < nh) {
            ...
            if (*lwork < iws) {
                ...
                /* Computing MAX */
                i__1 = 2, i__2 = ilaenv_(&c__2, "DGEHRD", " ", n, ilo, ihi, &c_n1);
                nbmin = max(i__1, i__2);
                if (*lwork >= *n * nbmin) {
                    nb = *lwork / *n;
                } else {
    ...
    if (nb < nbmin || nb >= nh) {
        ...
        for (i__ = *ilo; i__2 < 0 ? i__ >= i__1 : i__ <= i__1; i__ += i__2) {
            ...
            dlahr2_(ihi, &i__, &ib, &a[i__ * a_dim1 + 1], lda, &tau[i__], t, &c__65, &work[1],
                    &ldwork);
            ...
            dlarfb_("Left", "Transpose", "Forward", "Columnwise", &i__3, &i__4, &ib,
                    &a[i__ + 1 + i__ * a_dim1], lda, t, &c__65, &a[i__ + 1 + (i__ + ib) * a_dim1],
                    lda, &work[1], &ldwork);
            /* L40: */
        }
    }
