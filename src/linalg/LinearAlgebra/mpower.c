...
/*
 * This is the almost the same as powe, power on every element, but the difference is that this
 * function does not take power on each element, it does A^n A will be size row x row. It must be
 * square!!! A^n and n will be an integer
 */
