...
/*
 * Do repeate matrix.
 * If you have a matrix A with size row x column and you want to repeat matrix A horz=3 times to
 * left and vert=2 times down, Then you need a matrix B with size row*2 x column*3
 */
