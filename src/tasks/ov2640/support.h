// Various definitions that should already be defined in the main PVDXos project

#ifndef PVDX_ARDUCAM_DRIVER_SUPPORT_H
#define PVDX_ARDUCAM_DRIVER_SUPPORT_H



// Status codes (status_codes.h)
...
#endif //PVDX_ARDUCAM_DRIVER_SUPPORT_H
