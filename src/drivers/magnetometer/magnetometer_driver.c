...
// NOTE: As of April 12th, 2026, the I2C magnetometer driver is out of sync with the official pin config.
// As such, we have disabled it until a new driver is written.
//
